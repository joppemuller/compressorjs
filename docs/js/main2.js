  ...
  new Vue({
    ...
    mounted: function () {
      ...
      xhr.onload = function () {
        ...
        blob.name = '64c3c078c8b5a5a8b3c90070_picture.jpg';
        vm.compress(blob);
      };
      xhr.open('GET', 'https://uploads-ssl.webflow.com/64aabbfb4f094472de6a3236/64c3c078c8b5a5a8b3c90070_picture.jpg');
